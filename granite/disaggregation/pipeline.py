...
"""
 ...
 # Data Integrity Check: If high vulnerability has very good accessibility
 if avg_min_time < 6.0: # Very good accessibility (< 6min average)
 self._log(f"High vulnerability but excellent accessibility!")
 ...
 self._log("Less than 60% of features have correct correlation direction!")
